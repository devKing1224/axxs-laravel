...
return [
    ...
    */
    ...
    'email_title_inmate_create' => 'The user named :inmate_name(username- :inmate_id) has been created successfully.',
    ...
    'email_verified' => 'Congratulations, your email has been verified.',
    'contact_faility' => 'Something went wrong, Please contact to your facility admin',
    'email_verification_subject' => 'Email Verification - AxxS Tablet',
    'email_body_verification' => 'For verification and to except that all email content is available for the facility and Law Enforcement to view, please click on the link given below.',
