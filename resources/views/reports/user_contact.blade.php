<html>
    <table>
        <thead>
            ...
            <tr>
                ...
                <td>{{ $user->username }}</td>
                <td>@if(isset($serviceinfo->ServiceByUser))Yes @else No @endif</td>
            </tr>
    ...
    <table>
        <thead>
            ...
            @if(count($user->contactNumberList) > 0)
                 @foreach($user->contactNumberList as $index => $allnumber)
                    <tr>
                        ...
                        <td>{{ $allnumber->name }}</td>
                        <td>{{ phone_number_format($allnumber->email_phone) }}</td>
                    </tr>
                @endforeach
            @else
                <tr>
