...
<body>
    @if($content['mailbody']) {!! $content['mailbody'] !!}
   ...
   <br>
    ...
    <div style="margin-left:10px;">
        <b>From: </b>{{$content['forwardfrom']}} <br>
        <b>Sent: </b>{{ Carbon\Carbon::parse($content['datetime'])->format('jS, F Y,  h:i A') }} <br>
        <b>To: </b> {{$content['name'] }}<{{$content['from']}}>  <br>
