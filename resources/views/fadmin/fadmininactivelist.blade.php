...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Facility Admin Inactive List</h1>
        <ol class="breadcrumb">
            <li><a href="{{url('/dashboard')}}"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="{{url('/movies')}}">Facility Admin</a></li>
            <li class="active">Facility Admin Inactive List</li>
        </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <table id="fa_inactive-table" class="table table-striped table-condensed">
                            <thead>
                                  <tr>
                                    <th>S.No</th>
      ...
      <div class="modal-body">
        <form id="updateMovie" action="{{route('assign.facility')}}" enctype='multipart/form-data' method="POST">
          ...
          <div class="form-group">
              ...
              <br>
              <select style="width: 100%" class="form-control js-states  js-example-basic-multiple" id="facility_select" name="facility_id[]" multiple="multiple" required>
              </select>
            </div>
...
<script type="text/javascript">
    $(function() {
        ...
        language: {
        searchPlaceholder: "Search Facility Admin"
    },
        order: [[1, 'asc']]
        });
