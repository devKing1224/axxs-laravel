...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Facility Admin List</h1>
        <ol class="breadcrumb">
            <li><a href="{{url('/dashboard')}}"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a >Facility Admin</a></li>
            <li class="active">Facility Admin List</li>
        </ol>
    </section>
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <a href="{{route('fadmin.add')}}" class="btn btn-info" style="float: right;"><i class="fa fa-plus" aria-hidden="true"></i>
                    Add Facility Admin</a>
                    </div>
                    <div class="box-body">

                        <table id="fadmin-table" class="table table-striped table-condensed">
                            <thead>
                                  <tr>
                                    <th>S.No</th>
