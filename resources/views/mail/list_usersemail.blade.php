...
<script type="text/javascript">
    ...
    function viewemail($id) {
     ...
     function approve_email($id,$value) {
      if ($value == 2) {
        var color = "#d33";
        var text = 'Do you want to Reject this Email. An Automated Email will be sent to sender that his/her email was Rejected.';
      }else{
          color = "#7cd1f9";
          text = 'This Email Contains Attachment .If you have already approved Click Confirm';
      }
            swal({
      title: "Are you sure?",
      text: text,
